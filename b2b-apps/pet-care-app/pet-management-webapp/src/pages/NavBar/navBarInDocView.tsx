...
function NavBarInDoctorView(props: NavBarProps) {
    const {isBlur} = props;
        ...
        <>
            <Nav isBlur={isBlur}>
                ...
                <NavMenu>
                    ...
                    <NavLink to='/doctor_home' isSelected={path.includes('doctor_home') ? true : false} >
                        <NavIcon>
                            <HomeIcon style={{ width: "4vh", height: "4vh", padding: "1vh" }} />
                        </NavIcon>
                        Home
                    </NavLink>
                    <NavLink to='/doctor_profile' isSelected={path.includes('doctor_profile') ? true : false} >
                        <NavIcon>
                            <AccountBoxIcon style={{ width: "4vh", height: "4vh", padding: "1vh" }} />
                        </NavIcon>
                        Profile
                    </NavLink>
                    <NavLink to='/doctor_bookings' isSelected={path.includes('doctor_bookings') ? true : false}>
                        <NavIcon>
...
export default React.memo(NavBarInDoctorView);
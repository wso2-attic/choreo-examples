...
import { updateDocThumbnail } from '../../components/UploadDocThumbnail/put-doc-thumbnail';
...
function FileUploadSingle(props: FileUploadProps) {
    const {doctorId, imageUrl, setImageUrl} = props;
    ...
    return (
        <><div className='doc-upload-btn-div'>
            <button onClick={handleClick} className='doc-upload-btn-style-sec'>
                Choose a file
            </button>
            <input type="file"
                ref={hiddenFileInput}
        ...
        <div className='doc-upload-btn-div-sec'>
                <button className='doc-upload-btn-style-sec' onClick={() => {
                    handleUploadClick();
                }}>Upload</button>
            </div></>
    );
